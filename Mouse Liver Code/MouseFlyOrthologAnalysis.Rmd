...
mousegenes=intersect(sRCL,mousefly.orthologs[,"mouse.ensembl"])
i=2
...
linedata=matrix(0,nrow=18,ncol=5)

linedata=data.frame(linedata)
colnames(linedata)=c("Treatment","Time","Mean Relative Expression","Std. Dev.","Species")
linedata[,1]=c(rep("Control",5),rep("Rapamycin",5),rep("Control",4),rep("Rapamycin",4))
linedata[,2]=as.numeric(c(0,.5,1,2,4,0,.5,1,2,4,0,1,2,4,0,1,2,4))
linedata[,5]=c(rep("Mouse",10),rep("Fly",8))
linedata[,5]=paste(linedata[,5],linedata[,1])
linedata[,3]=as.numeric(c(mean(hmdata[,1]),mean(hmdata[,2]),mean(hmdata[,3]),mean(hmdata[,4]),mean(hmdata[,5]), mean(hmdata[,1]),mean(hmdata[,6]),mean(hmdata[,7]),mean(hmdata[,8]),mean(hmdata[,9]),
                        mean(hmdata[,10]),mean(hmdata[,11]),mean(hmdata[,12]),mean(hmdata[,13]),mean(hmdata[,10]), mean(hmdata[,14]),mean(hmdata[,15]),mean(hmdata[,16])))


linedata[,4]=as.numeric(c(sd(hmdata[,1]),sd(hmdata[,2]),sd(hmdata[,3]),sd(hmdata[,4]),sd(hmdata[,5]), sd(hmdata[,1]),sd(hmdata[,6]),sd(hmdata[,7]),sd(hmdata[,8]),sd(hmdata[,9]),
                        sd(hmdata[,10]),sd(hmdata[,11]),sd(hmdata[,12]),sd(hmdata[,13]),sd(hmdata[,10]), sd(hmdata[,14]),sd(hmdata[,15]),sd(hmdata[,16])))

p<- ggplot(linedata, aes(x=Time, y=linedata[,3], group=Species, color=Species)) + 
  geom_line(aes(linetype=Treatment, color=Species)) +
...
print(p+labs(title="Co-expression cluster 1", x="Refeeding Time (hours)", y = "Mean Relative Expression")+
   theme_classic() +
   scale_color_manual(values=c("darkgreen","gold3","royalblue","firebrick")))
...
mousegenes=intersect(sRCM,mousefly.orthologs[,"mouse.ensembl"])
i=2
sCM[.orthologs=na.omit(mousefly.orthologs[mousefly.orthologs[,"mouse.ensembl"]==mousegenes[1],])
while(i<=length(mousegenes)){
  temp=na.omit(mousefly.orthologs[mousefly.orthologs[,"mouse.ensembl"]==mousegenes[i],])
  sCM[.orthologs=rbind(sCM[.orthologs,temp)
  i=i+1
}
...
mousegenes=intersect(cluster,mousefly.orthologs[,"mouse.symbol"])
i=2
sCM[C1.orthologs=na.omit(mousefly.orthologs[mousefly.orthologs[,"mouse.symbol"]==mousegenes[1],])
while(i<=length(mousegenes)){
  temp=na.omit(mousefly.orthologs[mousefly.orthologs[,"mouse.symbol"]==mousegenes[i],])
  sCM[C1.orthologs=rbind(sCM[C1.orthologs,temp)
  i=i+1
}
...
mousegenes=intersect(cluster,mousefly.orthologs[,"mouse.symbol"])
i=2
sCM[C2.orthologs=na.omit(mousefly.orthologs[mousefly.orthologs[,"mouse.symbol"]==mousegenes[1],])
while(i<=length(mousegenes)){
  temp=na.omit(mousefly.orthologs[mousefly.orthologs[,"mouse.symbol"]==mousegenes[i],])
  sCM[C2.orthologs=rbind(sCM[C2.orthologs,temp)
  i=i+1
}
...
mousegenes=intersect(cluster,mousefly.orthologs[,"mouse.symbol"])
i=2
sCM[C3.orthologs=na.omit(mousefly.orthologs[mousefly.orthologs[,"mouse.symbol"]==mousegenes[1],])
while(i<=length(mousegenes)){
  temp=na.omit(mousefly.orthologs[mousefly.orthologs[,"mouse.symbol"]==mousegenes[i],])
  sCM[C3.orthologs=rbind(sCM[C3.orthologs,temp)
  i=i+1
}
...
mousegenes=intersect(cluster,mousefly.orthologs[,"mouse.symbol"])
i=2
sCM[C4.orthologs=na.omit(mousefly.orthologs[mousefly.orthologs[,"mouse.symbol"]==mousegenes[1],])
while(i<=length(mousegenes)){
  temp=na.omit(mousefly.orthologs[mousefly.orthologs[,"mouse.symbol"]==mousegenes[i],])
  sCM[C4.orthologs=rbind(sCM[C4.orthologs,temp)
  i=i+1
}
...
clusternum=1
title="sCL Cluster 1 of Cluster 1Mouse and Fly Orthologs"
...
cluster=temp.orthologs$mouse.symbol
...
plot(x=(x-.03), y, col="blue",cex=.1, main=title,xlab="Time",ylab="Relative Gene Expression")
##lines(spline(x, y))
...
clusternum=2
title="sCL Cluster 2 of Cluster 1Mouse and Fly Orthologs"
cluster=na.omit(row.names(hmdata)[unlist(dnd$lower[[clusternum]])])
mousegenes=intersect(cluster,mousefly.orthologs[,"mouse.symbol"])
i=2
temp.orthologs=na.omit(mousefly.orthologs[mousefly.orthologs[,"mouse.symbol"]==mousegenes[1],])
...
clusternum=3
title="sCL Cluster 3 of Cluster 1Mouse and Fly Orthologs"
cluster=na.omit(row.names(hmdata)[unlist(dnd$lower[[clusternum]])])
mousegenes=intersect(cluster,mousefly.orthologs[,"mouse.symbol"])
i=2
temp.orthologs=na.omit(mousefly.orthologs[mousefly.orthologs[,"mouse.symbol"]==mousegenes[1],])
...
clusternum=4
title="sCL Cluster 4 of Cluster 1 Mouse and Fly Orthologs"
cluster=na.omit(row.names(hmdata)[unlist(dnd$lower[[clusternum]])])
mousegenes=intersect(cluster,mousefly.orthologs[,"mouse.symbol"])
i=2
temp.orthologs=na.omit(mousefly.orthologs[mousefly.orthologs[,"mouse.symbol"]==mousegenes[1],])
...
clusternum=1
title="sCL Cluster 1 of Cluster 2 Mouse and Fly Orthologs"
cluster=na.omit(row.names(hmdata)[unlist(dnd$lower[[clusternum]])])
mousegenes=intersect(cluster,mousefly.orthologs[,"mouse.symbol"])
i=2
temp.orthologs=na.omit(mousefly.orthologs[mousefly.orthologs[,"mouse.symbol"]==mousegenes[1],])
...
clusternum=2
title="sCL Cluster 2 of Cluster 2 Mouse and Fly Orthologs"
cluster=na.omit(row.names(hmdata)[unlist(dnd$lower[[clusternum]])])
mousegenes=intersect(cluster,mousefly.orthologs[,"mouse.symbol"])
i=2
temp.orthologs=na.omit(mousefly.orthologs[mousefly.orthologs[,"mouse.symbol"]==mousegenes[1],])
...
clusternum=3
title="sCL Cluster 3 of Cluster 2 Mouse and Fly Orthologs"
cluster=na.omit(row.names(hmdata)[unlist(dnd$lower[[clusternum]])])
mousegenes=intersect(cluster,mousefly.orthologs[,"mouse.symbol"])
i=2
temp.orthologs=na.omit(mousefly.orthologs[mousefly.orthologs[,"mouse.symbol"]==mousegenes[1],])
...
clusternum=4
title="sCL Cluster 4 of Cluster 2 Mouse and Fly Orthologs"
cluster=na.omit(row.names(hmdata)[unlist(dnd$lower[[clusternum]])])
mousegenes=intersect(cluster,mousefly.orthologs[,"mouse.symbol"])
i=2
temp.orthologs=na.omit(mousefly.orthologs[mousefly.orthologs[,"mouse.symbol"]==mousegenes[1],])
...
clusternum=1
title="sCL Cluster 1 of Cluster 3 Mouse and Fly Orthologs"
cluster=na.omit(row.names(hmdata)[unlist(dnd$lower[[clusternum]])])
mousegenes=intersect(cluster,mousefly.orthologs[,"mouse.symbol"])
i=2
temp.orthologs=na.omit(mousefly.orthologs[mousefly.orthologs[,"mouse.symbol"]==mousegenes[1],])
...
clusternum=2
title="sCL Cluster 2 of Cluster 3 Mouse and Fly Orthologs"
cluster=na.omit(row.names(hmdata)[unlist(dnd$lower[[clusternum]])])
mousegenes=intersect(cluster,mousefly.orthologs[,"mouse.symbol"])
i=2
temp.orthologs=na.omit(mousefly.orthologs[mousefly.orthologs[,"mouse.symbol"]==mousegenes[1],])
...
clusternum=3
title="sCL Cluster 3 of Cluster 3 Mouse and Fly Orthologs"
cluster=na.omit(row.names(hmdata)[unlist(dnd$lower[[clusternum]])])
mousegenes=intersect(cluster,mousefly.orthologs[,"mouse.symbol"])
i=2
temp.orthologs=na.omit(mousefly.orthologs[mousefly.orthologs[,"mouse.symbol"]==mousegenes[1],])
...
clusternum=4
title="sCL Cluster 4 of Cluster 3 Mouse and Fly Orthologs"
cluster=na.omit(row.names(hmdata)[unlist(dnd$lower[[clusternum]])])
mousegenes=intersect(cluster,mousefly.orthologs[,"mouse.symbol"])
i=2
temp.orthologs=na.omit(mousefly.orthologs[mousefly.orthologs[,"mouse.symbol"]==mousegenes[1],])
...
clusternum=1
title="sCL Cluster 1 of Cluster 4 Mouse and Fly Orthologs"
cluster=na.omit(row.names(hmdata)[unlist(dnd$lower[[clusternum]])])
mousegenes=intersect(cluster,mousefly.orthologs[,"mouse.symbol"])
i=2
temp.orthologs=na.omit(mousefly.orthologs[mousefly.orthologs[,"mouse.symbol"]==mousegenes[1],])
...
clusternum=2
title="sCL Cluster 2 of Cluster 4 Mouse and Fly Orthologs"
cluster=na.omit(row.names(hmdata)[unlist(dnd$lower[[clusternum]])])
mousegenes=intersect(cluster,mousefly.orthologs[,"mouse.symbol"])
i=2
temp.orthologs=na.omit(mousefly.orthologs[mousefly.orthologs[,"mouse.symbol"]==mousegenes[1],])
...
clusternum=3
title="sCL Cluster 3 of Cluster 4 Mouse and Fly Orthologs"
cluster=na.omit(row.names(hmdata)[unlist(dnd$lower[[clusternum]])])
mousegenes=intersect(cluster,mousefly.orthologs[,"mouse.symbol"])
i=2
temp.orthologs=na.omit(mousefly.orthologs[mousefly.orthologs[,"mouse.symbol"]==mousegenes[1],])
...
clusternum=4
title="sCL Cluster 4 of Cluster 4 Mouse and Fly Orthologs"
cluster=na.omit(row.names(hmdata)[unlist(dnd$lower[[clusternum]])])
mousegenes=intersect(cluster,mousefly.orthologs[,"mouse.symbol"])
i=2
temp.orthologs=na.omit(mousefly.orthologs[mousefly.orthologs[,"mouse.symbol"]==mousegenes[1],])
...
clusternum=1
title="sRL Cluster 1 of Cluster 1 Mouse and Fly Orthologs"
cluster=na.omit(row.names(hmdata)[unlist(dnd$lower[[clusternum]])])
mousegenes=intersect(cluster,mousefly.orthologs[,"mouse.symbol"])
i=2
temp.orthologs=na.omit(mousefly.orthologs[mousefly.orthologs[,"mouse.symbol"]==mousegenes[1],])
