...
##2-way Venn
  grid.newpage()
draw.pairwise.venn(area1=length(s1),area2=length(s2),cross.area=length(intersect(s1,s2)),fill = c("gold","darkgreen"),cex=1.5,cat.cex = 1,category = c(set1,set2), title= "Rapamycin vs Control DEGs",inverted=T)
