...
BiocManager::install("pd.ragene.1.0.st.v1")
...
cpm(2^exprs(ES))
##The log base 2 normalized expression table
temp=2^exprs(ES)
cpmtemp=cpm(temp)
cutoff=7
cpmtemp=cpmtemp[cpmtemp[,1]>cutoff,]
cpmtemp=cpmtemp[cpmtemp[,2]>cutoff,]
cpmtemp=cpmtemp[cpmtemp[,3]>cutoff,]
cpmtemp=cpmtemp[cpmtemp[,4]>cutoff,]
dim(cpmtemp)
