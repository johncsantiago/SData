...
CN1.phys=phys.data["CN1",]
CN2.phys=phys.data["CN2",]
CN3.phys=phys.data["CN3",]
CN4.phys=phys.data["CN4",]
CN5.phys=phys.data["CN5",]

CV1.phys=phys.data["CV1",]
CV2.phys=phys.data["CV2",]
CV3.phys=phys.data["CV3",]
CV4.phys=phys.data["CV4",]
CV5.phys=phys.data["CV5",]

EM1.phys=phys.data["EM1",]
EM2.phys=phys.data["EM2",]
EM3.phys=phys.data["EM3",]
EM4.phys=phys.data["EM4",]
EM5.phys=phys.data["EM5",]

xcoords=pca$x[,1]
names(xcoords)[1]=phys.data[paste(substring(groups[names(xcoords)[1],"Library.ID"],1,2),substring(groups[names(xcoords)[1],"Library.ID"],4,4),sep=""),65]
