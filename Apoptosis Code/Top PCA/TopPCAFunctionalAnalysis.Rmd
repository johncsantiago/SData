...
entrez.conversion=getBM(attributes=c("ensembl_gene_id","entrezgene_id"),mart=ensembl)
ID.conversion=na.omit(ID.conversion)
entrez.conversion=t(na.omit(entrez.conversion))
row.names(ID.conversion)=ID.conversion[,1]
names(entrez.conversion)=entrez.conversion[1,]
...
write.csv(pc1.sig.GObp2,"/Users/johncsantiago/Documents/GitHub/SData/Apoptosis Code/Top PCA/ApoptosisPaper PC1 GO BP Enrichment.csv")
```
...
write.csv(pc2.sig.GOcc1,"/Users/johncsantiago/Documents/GitHub/SData/Apoptosis Code/Top PCA/ApoptosisPaper PC2 Cluster 1 GO CC Enrichment.csv")
```
...
write.csv(pc2.sig.GObp2,"/Users/johncsantiago/Documents/GitHub/SData/Apoptosis Code/Top PCA/ApoptosisPaper PC2 Cluster 2 GO BP Enrichment.csv")
```
...
scaledID=ID.conversion[row.names(scaled),]
row.names(scaled)=scaledID[,2]
colors=c("burlywood4","seagreen4","darkkhaki","lightblue4","cornsilk4",
         "darkgreen","mediumpurple4","chocolate",
         "firebrick","green3","deepskyblue",
         "gold3","goldenrod","royalblue",
         "black","violet","darkorange3",
...
pc3.sig.GO1=sig.GO
pc3.sig.GObp1=sig.GObp
pc3.sig.GOmf1=sig.GOmf
pc3.sig.GOcc1=sig.GOcc
pc3.sig.slims1=sig.slims
pc3.sig.slimsbp1=sig.slimsbp
pc3.sig.slimsmf1=sig.slimsmf
pc3.sig.slimscc1=sig.slimscc
pc3.sig.KEGG1=sig.KEGG
pc3.sigs1=sigs
pc3.cluster1=cluster
...
pc3.sig.GObp1.genes=gmt
write.table(gmt, file="/Users/johncsantiago/Documents/GitHub/SData/Apoptosis Code/Top PCA/PC3_Cluster1_GObp.txt", sep="\t", col.names = F, row.names = F)
##write.csv(gmt, file="/Users/johncsantiago/Documents/GitHub/SData/Apoptosis Code/Top PCA/PC3_Cluster1_GObp.gmt")
write.table(gmt, file="/Users/johncsantiago/Documents/GitHub/SData/Apoptosis Code/Top PCA/PC3_Cluster1_GObp.gmt", sep="\t", col.names = F, row.names = F)
write.csv(cluster,"/Users/johncsantiago/Documents/GitHub/SData/Apoptosis Code/Top PCA/PC3_Cluster1_genes.csv")
write.csv(pc3.sig.GO1,"/Users/johncsantiago/Documents/GitHub/SData/Apoptosis Code/Top PCA/ApoptosisPaper PC3 Cluster 1 GO BP Enrichment.csv")
```
...
pc3.sig.GO2=sig.GO
pc3.sig.GObp2=sig.GObp
pc3.sig.GOmf2=sig.GOmf
pc3.sig.GOcc2=sig.GOcc
pc3.sig.slims2=sig.slims
pc3.sig.slimsbp2=sig.slimsbp
pc3.sig.slimsmf2=sig.slimsmf
pc3.sig.slimscc2=sig.slimscc
pc3.sig.KEGG2=sig.KEGG
pc3.sigs2=sigs
pc3.cluster2=cluster
...
pc3.sig.GObp2.genes=gmt
write.table(gmt, file="/Users/johncsantiago/Documents/GitHub/SData/Apoptosis Code/Top PCA/PC3_Cluster2_GObp.txt", sep="\t", col.names = F, row.names = F)
##write.csv(gmt, file="/Users/johncsantiago/Documents/GitHub/SData/Apoptosis Code/Top PCA/PC3_Cluster2_GObp.gmt")
write.table(gmt, file="/Users/johncsantiago/Documents/GitHub/SData/Apoptosis Code/Top PCA/PC3_Cluster2_GObp.gmt", sep="\t", col.names = F, row.names = F)

write.csv(cluster,"/Users/johncsantiago/Documents/GitHub/SData/Apoptosis Code/Top PCA/PC3_Cluster2_genes.csv")
write.csv(pc3.sig.GObp2,"/Users/johncsantiago/Documents/GitHub/SData/Apoptosis Code/Top PCA/ApoptosisPaper PC3 Cluster 2 GO BP Enrichment.csv")
```
...
heatmap.2(scaled[ID.conversion[(gmt[gmt[,1]=="meiotic cell cycle",3:27]),2],],trace="none",col=hmcolors, dendrogram = "none", Rowv=F,Colv="NA",cexRow = .5)
...
GOclustercats=read.csv("/Users/johncsantiago/Documents/GitHub/SData/Apoptosis Code/Top PCA/TopPCGOTermsClusters.csv")

temp=(pc2.sig.GOcc1)
row.names(temp)=temp$term

temp2=(pc2.sig.GObp2)
row.names(temp2)=temp2$term

temp3=(pc1.sig.GObp2)
row.names(temp3)=temp3$term

GOclustercats[GOclustercats$PC=="PC2"&GOclustercats$Cluster=="Cluster 1", "NumDEInCat"]=temp[GOclustercats$Term[GOclustercats$PC=="PC2"&GOclustercats$Cluster=="Cluster 1"],"numDEInCat"]

GOclustercats[GOclustercats$PC=="PC2"&GOclustercats$Cluster=="Cluster 2", "NumDEInCat"]=temp2[GOclustercats$Term[GOclustercats$PC=="PC2"&GOclustercats$Cluster=="Cluster 2"],"numDEInCat"]

GOclustercats[GOclustercats$PC=="PC1"&GOclustercats$Cluster=="Cluster 2", "NumDEInCat"]=temp3[GOclustercats$Term[GOclustercats$PC=="PC1"&GOclustercats$Cluster=="Cluster 2"],"numDEInCat"]

GOclustercats[GOclustercats$PC=="PC2"&GOclustercats$Cluster=="Cluster 1", "FDR"]=temp[GOclustercats$Term[GOclustercats$PC=="PC2"&GOclustercats$Cluster=="Cluster 1"],"adjp"]

GOclustercats[GOclustercats$PC=="PC2"&GOclustercats$Cluster=="Cluster 2", "FDR"]=temp2[GOclustercats$Term[GOclustercats$PC=="PC2"&GOclustercats$Cluster=="Cluster 2"],"adjp"]

GOclustercats[GOclustercats$PC=="PC1"&GOclustercats$Cluster=="Cluster 2", "FDR"]=temp3[GOclustercats$Term[GOclustercats$PC=="PC1"&GOclustercats$Cluster=="Cluster 2"],"adjp"]

write.csv(GOclustercats,"/Users/johncsantiago/Documents/GitHub/SData/Apoptosis Code/Top PCA/TopPCGOTermsClusters.csv")

pc2c1terms=GOclustercats[GOclustercats$PC=="PC2"&GOclustercats$Cluster=="Cluster 1", c("Term","ClusterName")]
pc2c2terms=GOclustercats[GOclustercats$PC=="PC2"&GOclustercats$Cluster=="Cluster 2", c("Term","ClusterName")]
pc1c2terms=GOclustercats[GOclustercats$PC=="PC1"&GOclustercats$Cluster=="Cluster 2", c("Term","ClusterName")]

tempdata=pc2c1terms
tempdata2=pc2.sig.GOcc1.genes
row.names(tempdata2)=tempdata2[,1]
tempdata2=tempdata2[,3:ncol(tempdata2)]
temp4=unique(tempdata$ClusterName)
tempdata2.genesinterm=matrix("",nrow=length(temp4),ncol=500)
row.names(tempdata2.genesinterm)=temp4
i=1
while(i<=length(temp4)){
temp5=tempdata[tempdata$ClusterName==temp4[i],]
tempdata3=as.vector(tempdata2[temp5$Term,])
tempdata3=unique(tempdata3[tempdata3!=""])
tempdata3=ID.conversion[tempdata3,2]
tempdata2.genesinterm[i,1:length(tempdata3)]=tempdata3
i=i+1
}

pc2c1.genesinGOclusters=tempdata2.genesinterm[,c(1,1:ncol(tempdata2.genesinterm))]
pc2c1.genesinGOclusters[,1]="PC2 Cluster 1"

tempdata=pc2c2terms
tempdata2=pc2.sig.GObp2.genes
row.names(tempdata2)=tempdata2[,1]
tempdata2=tempdata2[,3:ncol(tempdata2)]
temp4=unique(tempdata$ClusterName)
tempdata2.genesinterm=matrix("",nrow=length(temp4),ncol=500)
...
pc2c2.genesinGOclusters=tempdata2.genesinterm[,c(1,1:ncol(tempdata2.genesinterm))]
pc2c2.genesinGOclusters[,1]="PC2 Cluster 2"

tempdata=pc1c2terms
tempdata2=pc1.sig.GObp2.genes
row.names(tempdata2)=tempdata2[,1]
tempdata2=tempdata2[,3:ncol(tempdata2)]
temp4=unique(tempdata$ClusterName)
tempdata2.genesinterm=matrix("",nrow=length(temp4),ncol=500)
...
pc1c2.genesinGOclusters=tempdata2.genesinterm[,c(1,1:ncol(tempdata2.genesinterm))]
pc1c2.genesinGOclusters[,1]="PC1 Cluster 2"

GenesInGOClusters=rbind(pc1c2.genesinGOclusters,rbind(pc2c1.genesinGOclusters,pc2c2.genesinGOclusters))

write.csv(GenesInGOClusters,"/Users/johncsantiago/Documents/GitHub/SData/Apoptosis Code/Top PCA/GenesInEachGOCluster.csv")
