...
visNetwork(nodes,visedges)%>%
  ...
  visGroups(groupname = "Inflammatory cell apoptotic process parent", shape = "box", color = list(background = "green", border="black"),font=list(color="white",size=50),physics=F)%>%
    ...
    visGroups(groupname = "Extrinsic apoptotic signaling pathway parent", shape = "box", color = list(background = "red", border="black"),font=list(color="black",size=50),physics=F)%>%  
  ...
  visGroups(groupname = "Inflammatory cell apoptotic process", shape = "box", color = list(background = "green", border="black"),font=list(color="black",size=50),physics=T)%>%
  
    visGroups(groupname = "Extrinsic apoptotic signaling pathway", shape = "box", color = list(background = "red", border="black"),font=list(color="black",size=50),physics=T)%>%  
  ...
  visLegend(addNodes = list(list(label = "Intrinsic apoptotic signaling pathway parent", shape = "box", color = list(background = "dodgerblue", border="black"),font=list(color="black",size=50)),
                            list(label= "Inflammatory cell apoptotic process parent", shape = "box", color = list(background = "green", border="black"),font=list(color="black",size=50)),
